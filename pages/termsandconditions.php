...
<body>
    ...
    <main class="termsncond-page">
        <div class="image-section">
            <img src="../assets/media/images/08.png" alt="Image">
        </div>
        <!--  -->
        <div class="container">
            <h1 class="my-5">Terms & Conditions</h1>
            <div>
                <h2 class="my-5">Introduction</h2>
                <p>
                    The terms and conditions written in this website shall control your
                    use of our website. These terms may be applied genuinely and affect
                    your use of this website. By the way of using this website, you agreed
                    to accept all the terms and conditions written here. You need to no
                    longer use this website in case you disagree with any of these
